...
// Hostija SMTP transporter
const transporter = nodemailer.createTransport({
    host: 'mail.toxicgame.net',
    port: 587,
    secure: false,
    auth: {
...
// OTP email function with full HTML template
...
<body>
    <div class="email-container">
        <div class="header">
            ...
            <div class="tagline">THE BEST Mac, PC GAMES PLATFORM</div>
        </div>
        ...
        <div class="footer">
            ...
            <div class="footer-links">
                ...
                <a href="https://toxicgames.in/policy">Privacy Policy</a>
            </div>
    ...
    const textContent = `
TOXICGAMES - THE BEST PRE-INSTALLED GAMES PLATFORM
...
SECURITY ALERT: Never share this OTP with anyone. ToxicGames will never ask for your OTP, password, or other sensitive information.

If you didn't request this OTP, please ignore this email or contact our support team immediately.

---
Discord | Reddit | TikTok
© 2025 ToxicGames. All rights reserved.
    `;
